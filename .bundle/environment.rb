...
module Bundler
  ...
  SPECS        = [
        ...
        {:load_paths=>["/opt/local/lib/ruby/gems/1.8/gems/pg-0.8.0/lib"], :loaded_from=>"/opt/local/lib/ruby/gems/1.8/specifications/pg-0.8.0.gemspec"},
        {:load_paths=>["/opt/local/lib/ruby/gems/1.8/gems/activerecord-2.2.2/lib"], :loaded_from=>"/opt/local/lib/ruby/gems/1.8/specifications/activerecord-2.2.2.gemspec"},
        {:load_paths=>["/opt/local/lib/ruby/gems/1.8/gems/activeresource-2.2.2/lib"], :loaded_from=>"/opt/local/lib/ruby/gems/1.8/specifications/activeresource-2.2.2.gemspec"},
        {:load_paths=>["/opt/local/lib/ruby/gems/1.8/gems/rails-2.2.2/lib"], :loaded_from=>"/opt/local/lib/ruby/gems/1.8/specifications/rails-2.2.2.gemspec"},
      ].map do |hash|
